...
# Load the dataset
input_file_path = '../../input_datasets/part_a/part_a_input_dataset_5.csv'
...
output_file_path = '../../output_datasets/part_a/part_a_dataset_5.csv'
...
data1 = {
    "Dataset": ["part_a_input_dataset_5"],
